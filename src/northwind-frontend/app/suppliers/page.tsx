...
export default function Suppliers() {
  ...
  const {
    ...
    queryKey: ["suppliers", pageIndex, pageSize, orderBy, isAscending, filter],
    queryFn: async () => {
      ...
      const res = await axios.get<{
        ...
        `http://localhost:5205/Supplier/skip/${skip}/take/${take}/orderby/${orderBy}/asc/${isAscending}/filter/${encodeURIComponent(
          filter
        )}`
      );
      return res.data;
