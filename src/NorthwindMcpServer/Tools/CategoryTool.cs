...
public static class CategoryTool
{
    ...
    public static ValueTask<List<Category>> GetAll(
    ...
    public static ValueTask<PagedList<Category>?> GetPaged(
        HttpClient httpClient,
        ...
        CancellationToken cancellationToken)
    => ToolHelpers.GetPaged<Category>(httpClient, entity, JsonSerializerOptions, skip, take, orderBy, filter, cancellationToken);

    [McpServerTool, Description($"Gets the {entity} details from the API with given id and return back to the client as {entity} details.")]
    public static ValueTask<Category?> GetById(
            HttpClient httpClient,
            [Description($"id of the {entity}")] int id,
            CancellationToken cancellationToken)
    => ToolHelpers.GetById<Category>(httpClient, entity, JsonSerializerOptions, id, cancellationToken);
    ...
    public static ValueTask<Category> Save(
        HttpClient httpClient,
    ...
    public static ValueTask Delete(
        HttpClient httpClient,
