...
public partial class InstnwndContext : DbContext
{
    public InstnwndContext()
    {
    }

    public InstnwndContext(DbContextOptions<InstnwndContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK_41fb077311758c7fdb08f4f450d");
